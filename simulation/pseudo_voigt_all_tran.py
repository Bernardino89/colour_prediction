...
# program generate a Pseudo Voigt profile. At the end, pseudo_voigt_all.py sum all Pseudo Voigt in order to find the 
# spectra. pseudo_voigt_all.py generates a file, spectra.txt, that contain the epsilon and the vawelight. 
#												 
#												 
#												 
# command line to use the program:								 
# 												 
#  				python.3.5 pseudo_voigt_all.py file_name.log > test			 
# 												 
#												 
##################################################################################################
