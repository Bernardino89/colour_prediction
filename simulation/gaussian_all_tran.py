...
# program generate a gauusan curve. At the end, spectra.py sum all gaussian in order to find the #
# spectra. spectra.py generates a file, spectra.txt, that contain the epsilon and the vawelight. #
#												 #
#												 #
#												 #
# command line to use the program:								 #
# 												 #
#  				python.3.5 spectra.py file_name.log > test			 #
# 												 #
#												 #
##################################################################################################
