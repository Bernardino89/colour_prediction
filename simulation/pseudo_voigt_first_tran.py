...
# program generate a Pseudo Voigt profile.
# Pseudo_voigt_first_tran.py generates a file, spectra.txt, that contain the epsilon and the vawelight. 
#												 
#												 
#												 
# command line to use the program:								 
# 												 
#  				python.3.5 pseudo_voigt_first_tran.py file_name.log > test			 
# 												 
#												 
##################################################################################################
